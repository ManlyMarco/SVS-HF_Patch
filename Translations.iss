...
MsgExeNotFound=WARNING - Summer Vacation! Scramble files were not found in selected directory. This patch has to be installed directly to the main game directory in order to work properly.%n%nAre you sure that this directory is correct?
...
RunGame=&Run Summer Vacation! Scramble
RunWiki=Open Summer Vacation! Scramble wiki (FAQ, English manual)
...
jp.MsgMissingDLC1=注意 - 「サマバケ！すくらんぶる ドルチェ+DIGITAL CRAFT」(2023-12-22)のオプションのアップデートが欠けています。%n%n使用したい場合は、HF Patchを実行する前にインストールしてください。
...
MsgSteamUpdatesMissing=Your game is missing official updates from Steam. Please go to your Steam Library and update Summer Vacation! Scramble before installing this patch.
